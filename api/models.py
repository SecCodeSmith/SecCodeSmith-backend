...
class Contact(models.Model):
    ...
    def __str__(self):
        return "Email: {} Business email {} Phone {} Lang {}".format(
            self.email, self.business_email, self.phone, self.language
        )
...
class ProfessionalJourney(models.Model):
    ...
    about = models.ForeignKey(
        About,
        on_delete=models.CASCADE,
        verbose_name=_("About_ProfessionalJourney"),
        null=True,
    )
...
class TechnicalArsenalSkill(models.Model):
    ...
    technical_arsenal = models.ForeignKey(
        TechnicalArsenal,
        on_delete=models.CASCADE,
